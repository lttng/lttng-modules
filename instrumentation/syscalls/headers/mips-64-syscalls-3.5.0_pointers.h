...
SC_LTTNG_TRACEPOINT_EVENT(sys_shmdt,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_rt_sigpending,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_sched_rr_get_interval,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_sigaction,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_shmctl,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_msgctl,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_sched_setaffinity,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_sched_getaffinity,
	TP_PROTO(pid_t pid, unsigned int len, unsigned long * user_mask_ptr),
	TP_ARGS(pid, len, user_mask_ptr),
	TP_STRUCT__entry(__field(pid_t, pid) __field(unsigned int, len) __field_hex(unsigned long *, user_mask_ptr)),
	TP_fast_assign(tp_assign(pid, pid) tp_assign(len, len) tp_assign(user_mask_ptr, user_mask_ptr)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_shmat,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_semop,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_rt_sigqueueinfo,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_truncate64,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_msgsnd,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_semtimedop,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_rt_sigaction,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_rt_sigprocmask,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_sendfile,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_newfstatat,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_llseek,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_waitid,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_msgrcv,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_pread,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_pwrite,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_fanotify_mark,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_process_vm_readv,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_process_vm_writev,
	TP_PROTO(pid_t pid, const struct iovec * lvec, unsigned long liovcnt, const struct iovec * rvec, unsigned long riovcnt, unsigned long flags),
	TP_ARGS(pid, lvec, liovcnt, rvec, riovcnt, flags),
	TP_STRUCT__entry(__field(pid_t, pid) __field_hex(const struct iovec *, lvec) __field(unsigned long, liovcnt) __field_hex(const struct iovec *, rvec) __field(unsigned long, riovcnt) __field(unsigned long, flags)),
	TP_fast_assign(tp_assign(pid, pid) tp_assign(lvec, lvec) tp_assign(liovcnt, liovcnt) tp_assign(rvec, rvec) tp_assign(riovcnt, riovcnt) tp_assign(flags, flags)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_32_futex,
