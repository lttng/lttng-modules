...
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_restart_syscall)
#endif
#ifndef OVERRIDE_32_sys_getpid
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getpid)
#endif
#ifndef OVERRIDE_32_sys_getuid16
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getuid16)
#endif
#ifndef OVERRIDE_32_sys_pause
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_pause)
#endif
#ifndef OVERRIDE_32_sys_sync
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_sync)
#endif
#ifndef OVERRIDE_32_sys_getgid16
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getgid16)
#endif
#ifndef OVERRIDE_32_sys_geteuid16
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_geteuid16)
#endif
#ifndef OVERRIDE_32_sys_getegid16
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getegid16)
#endif
#ifndef OVERRIDE_32_sys_getppid
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getppid)
#endif
#ifndef OVERRIDE_32_sys_getpgrp
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getpgrp)
#endif
#ifndef OVERRIDE_32_sys_setsid
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_setsid)
#endif
#ifndef OVERRIDE_32_sys_vhangup
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_vhangup)
#endif
#ifndef OVERRIDE_32_sys_munlockall
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_munlockall)
#endif
...
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getuid)
#endif
#ifndef OVERRIDE_32_sys_getgid
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getgid)
#endif
#ifndef OVERRIDE_32_sys_geteuid
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_geteuid)
#endif
#ifndef OVERRIDE_32_sys_getegid
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_getegid)
#endif
#ifndef OVERRIDE_32_sys_gettid
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_gettid)
#endif
#ifndef OVERRIDE_32_sys_inotify_init
SC_LTTNG_TRACEPOINT_EVENT_INSTANCE_NOARGS(syscalls_noargs, sys_inotify_init)
#endif
#ifndef OVERRIDE_32_sys_exit
SC_LTTNG_TRACEPOINT_EVENT(sys_exit,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_close,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setuid16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_nice,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_dup,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_brk,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setgid16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_umask,
	TP_PROTO(int mask),
	TP_ARGS(mask),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fsync,
	TP_PROTO(unsigned int fd),
	TP_ARGS(fd),
	TP_STRUCT__entry(__field(unsigned int, fd)),
	TP_fast_assign(tp_assign(fd, fd)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_getpgid,
	TP_PROTO(pid_t pid),
	TP_ARGS(pid),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fchdir,
	TP_PROTO(unsigned int fd),
	TP_ARGS(fd),
	TP_STRUCT__entry(__field(unsigned int, fd)),
	TP_fast_assign(tp_assign(fd, fd)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_personality,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setfsuid16,
	TP_PROTO(old_uid_t uid),
	TP_ARGS(uid),
	TP_STRUCT__entry(__field(old_uid_t, uid)),
	TP_fast_assign(tp_assign(uid, uid)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setfsgid16,
	TP_PROTO(old_gid_t gid),
	TP_ARGS(gid),
	TP_STRUCT__entry(__field(old_gid_t, gid)),
	TP_fast_assign(tp_assign(gid, gid)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_getsid,
	TP_PROTO(pid_t pid),
	TP_ARGS(pid),
	TP_STRUCT__entry(__field(pid_t, pid)),
	TP_fast_assign(tp_assign(pid, pid)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fdatasync,
	TP_PROTO(unsigned int fd),
	TP_ARGS(fd),
	TP_STRUCT__entry(__field(unsigned int, fd)),
	TP_fast_assign(tp_assign(fd, fd)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mlockall,
	TP_PROTO(int flags),
	TP_ARGS(flags),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_sched_getscheduler,
	TP_PROTO(pid_t pid),
	TP_ARGS(pid),
	TP_STRUCT__entry(__field(pid_t, pid)),
	TP_fast_assign(tp_assign(pid, pid)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_sched_get_priority_max,
	TP_PROTO(int policy),
	TP_ARGS(policy),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_sched_get_priority_min,
	TP_PROTO(int policy),
	TP_ARGS(policy),
	TP_STRUCT__entry(__field(int, policy)),
	TP_fast_assign(tp_assign(policy, policy)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setuid,
	TP_PROTO(uid_t uid),
	TP_ARGS(uid),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setgid,
	TP_PROTO(gid_t gid),
	TP_ARGS(gid),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setfsuid,
	TP_PROTO(uid_t uid),
	TP_ARGS(uid),
	TP_STRUCT__entry(__field(uid_t, uid)),
	TP_fast_assign(tp_assign(uid, uid)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setfsgid,
	TP_PROTO(gid_t gid),
	TP_ARGS(gid),
	TP_STRUCT__entry(__field(gid_t, gid)),
	TP_fast_assign(tp_assign(gid, gid)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_io_destroy,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_exit_group,
	TP_PROTO(int error_code),
	TP_ARGS(error_code),
	TP_STRUCT__entry(__field(int, error_code)),
	TP_fast_assign(tp_assign(error_code, error_code)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_epoll_create,
	TP_PROTO(int size),
	TP_ARGS(size),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_timer_getoverrun,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_timer_delete,
	TP_PROTO(timer_t timer_id),
	TP_ARGS(timer_id),
	TP_STRUCT__entry(__field(timer_t, timer_id)),
	TP_fast_assign(tp_assign(timer_id, timer_id)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_unshare,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_eventfd,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_epoll_create1,
	TP_PROTO(int flags),
	TP_ARGS(flags),
	TP_STRUCT__entry(__field(int, flags)),
	TP_fast_assign(tp_assign(flags, flags)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_inotify_init1,
	TP_PROTO(int flags),
	TP_ARGS(flags),
	TP_STRUCT__entry(__field(int, flags)),
	TP_fast_assign(tp_assign(flags, flags)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_syncfs,
	TP_PROTO(int fd),
	TP_ARGS(fd),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_kill,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setpgid,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_dup2,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setreuid16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setregid16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_munmap,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_ftruncate,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fchmod,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_getpriority,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_bdflush,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_flock,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mlock,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_munlock,
	TP_PROTO(unsigned long start, size_t len),
	TP_ARGS(start, len),
	TP_STRUCT__entry(__field(unsigned long, start) __field(size_t, len)),
	TP_fast_assign(tp_assign(start, start) tp_assign(len, len)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setreuid,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setregid,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_tkill,
	TP_PROTO(pid_t pid, int sig),
	TP_ARGS(pid, sig),
	TP_STRUCT__entry(__field(pid_t, pid) __field(int, sig)),
	TP_fast_assign(tp_assign(pid, pid) tp_assign(sig, sig)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_listen,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_shutdown,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_msgget,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_ioprio_get,
	TP_PROTO(int which, int who),
	TP_ARGS(which, who),
	TP_STRUCT__entry(__field(int, which) __field(int, who)),
	TP_fast_assign(tp_assign(which, which) tp_assign(who, who)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_inotify_rm_watch,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_timerfd_create,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_eventfd2,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fanotify_init,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setns,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_lseek,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_ioctl,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fcntl,
	TP_PROTO(unsigned int fd, unsigned int cmd, unsigned long arg),
	TP_ARGS(fd, cmd, arg),
	TP_STRUCT__entry(__field(unsigned int, fd) __field(unsigned int, cmd) __field(unsigned long, arg)),
	TP_fast_assign(tp_assign(fd, fd) tp_assign(cmd, cmd) tp_assign(arg, arg)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fchown16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setpriority,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mprotect,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_sysfs,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_msync,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setresuid16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setresgid16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fchown,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setresuid,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setresgid,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_madvise,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_fcntl64,
	TP_PROTO(unsigned int fd, unsigned int cmd, unsigned long arg),
	TP_ARGS(fd, cmd, arg),
	TP_STRUCT__entry(__field(unsigned int, fd) __field(unsigned int, cmd) __field(unsigned long, arg)),
	TP_fast_assign(tp_assign(fd, fd) tp_assign(cmd, cmd) tp_assign(arg, arg)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_tgkill,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_socket,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_semget,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_shmget,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_ioprio_set,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_dup3,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_ptrace,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_tee,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mremap,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_prctl,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_remap_file_pages,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_keyctl,
	TP_PROTO(int option, unsigned long arg2, unsigned long arg3, unsigned long arg4, unsigned long arg5),
	TP_ARGS(option, arg2, arg3, arg4, arg5),
	TP_STRUCT__entry(__field(int, option) __field(unsigned long, arg2) __field(unsigned long, arg3) __field(unsigned long, arg4) __field(unsigned long, arg5)),
	TP_fast_assign(tp_assign(option, option) tp_assign(arg2, arg2) tp_assign(arg3, arg3) tp_assign(arg4, arg4) tp_assign(arg5, arg5)),
