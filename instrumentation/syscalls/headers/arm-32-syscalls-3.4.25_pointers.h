...
SC_LTTNG_TRACEPOINT_EVENT(sys_pipe,
	TP_PROTO(int * fildes),
	TP_ARGS(fildes),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_acct,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mq_unlink,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_getgroups16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_setgroups16,
	TP_PROTO(int gidsetsize, old_gid_t * grouplist),
	TP_ARGS(gidsetsize, grouplist),
	TP_STRUCT__entry(__field(int, gidsetsize) __field_hex(old_gid_t *, grouplist)),
	TP_fast_assign(tp_assign(gidsetsize, gidsetsize) tp_assign(grouplist, grouplist)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mq_notify,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_lchown16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_getresuid16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_getresgid16,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_chown16,
	TP_PROTO(const char * filename, old_uid_t user, old_gid_t group),
	TP_ARGS(filename, user, group),
	TP_STRUCT__entry(__string_from_user(filename, filename) __field(old_uid_t, user) __field(old_gid_t, group)),
	TP_fast_assign(tp_copy_string_from_user(filename, filename) tp_assign(user, user) tp_assign(group, group)),
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mq_getsetattr,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mq_open,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_request_key,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mq_timedsend,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_mq_timedreceive,
...
SC_LTTNG_TRACEPOINT_EVENT(sys_add_key,
