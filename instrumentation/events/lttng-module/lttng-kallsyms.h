...
LTTNG_TRACEPOINT_EVENT(lttng_kallsyms_symbol_module,
...
LTTNG_TRACEPOINT_EVENT(lttng_kallsyms_symbol_core,

	TP_PROTO(struct lttng_session *session,
		unsigned long addr, const char *symbol),

	TP_ARGS(session, addr, symbol),
